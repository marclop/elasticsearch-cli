## elasticsearch-cli generate

Generates elasticsearch-cli completions and docs
...
```
elasticsearch-cli generate [flags]
```
...
* [elasticsearch-cli generate docs](elasticsearch-cli_generate_docs.md)	 - Generates the command tree documentation
